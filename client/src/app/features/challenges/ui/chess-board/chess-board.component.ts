...
@Component({
  imports: [ChessBoardCellColor, NgClass, HysIconPositionDirective],
  selector: 'app-chess-board-view',
  templateUrl: './chess-board.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    class:
      'block w-[200px] h-[200px] rounded-md border border-gray-400 overflow-hidden',
  },
})
